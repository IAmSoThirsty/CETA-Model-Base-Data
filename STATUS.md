...
- Curriculum v2 contains 690 VM-validated cases across 230 structural families and all 23 operations, with 2,760 explicit hostile alternatives.
...
- A full 552-case CPU reference epoch completed across pause/restart/resume with exact training split coverage.
...
- The synthetic curriculum does not solve language-to-state grounding or observation truth determination.
- The reference action-space generator is bounded and is not claimed exhaustive for arbitrary future CETA states.
- No production-scale model architecture, distributed trainer, GPU-specific performance profile, HSM/TPM key custody, or Byzantine consensus is claimed.
