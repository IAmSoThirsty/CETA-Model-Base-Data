...
STATUS_VOCAB=(
    NONE_TOKEN,"ACTIVE","OBSERVED","VALIDATED","ADMITTED","REJECTED","AUTHORIZED",
...
VERIFICATION_VOCAB=(NONE_TOKEN,"UNVERIFIED","VERIFIED","INVALID","PENDING_EXTERNAL_VERIFICATION")
VERIFICATION_TO_INDEX={name:i for i,name in enumerate(VERIFICATION_VOCAB)}

EPISTEMIC_STATUS_VOCAB=(NONE_TOKEN,"OPEN","SUPPORTED","CONTESTED","UNDERCUT")
